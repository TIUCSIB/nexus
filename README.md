...
```bash
# 默认端口 6100
bash <(curl -fsSL https://raw.githubusercontent.com/TIUCSIB/nexus/main/scripts/install-panel.sh)

# 自定义端口
bash <(curl -fsSL https://raw.githubusercontent.com/TIUCSIB/nexus/main/scripts/install-panel.sh) --port 8080
```
...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/TIUCSIB/nexus/main/scripts/install-agent.sh) \
